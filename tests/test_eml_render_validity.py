...
def _load_renders():
    ...
    candidates += [
        ...
        Path(__file__).resolve().parents[2] / "PrincipiaMetaphysica" / "AutoGenerated" / "formula_renders.json",
...
def _load_offer_policy():
    ...
    candidates += [
        ...
        Path(__file__).resolve().parents[2] / "PrincipiaMetaphysica" / "AutoGenerated" / "eml_offer_policy.json",
