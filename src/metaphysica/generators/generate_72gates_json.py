...
GATES_72 = [
    ...
    {"id": 60, "name": "DESI Static Anchor", "phase": 5, "block": "F",
     "logic": "w_a = -4/sqrt(b3) thawing evolution (FITTED dim(Psi)=4 projection)",
     "validation": "0.54 sigma vs DESI w_a = -0.99 +/- 0.32",
     "formula": "w_a = -4/√24 = -0.8165", "domain": "Cosmology",
     "derived": -0.8165, "experimental": -0.99, "units": ""},
