...
from metaphysica.simulations.core.free_variable_ledger import (
    published_free_variable_count as _free_variable_count,
)
...
# The dof subtrahend used by the chi-squared arithmetic below. It is an
# ANSATZ and is named as one: "only k_gimel is fitted" is an assertion about
# the framework, not a count of anything, and the free-variable ledger
# measures 65 non-derived quantities in this tree. Left at 1 deliberately --
# moving it moves reduced chi-squared and every verdict downstream of it,
# which is an author ruling, not a refactor. What it must NOT do any longer
# is answer "how many free variables does this theory have?": that question
# now has exactly one answer, and it comes from the ledger.
DOF_SUBTRAHEND_ANSATZ = 1  # ANSATZ: b3, chi_eff, phi treated as mathematical

#: Backwards-compatible alias. Kept so no import breaks; the name was the
#: problem, because it read as a measured count.
FITTED_PARAMS_COUNT = DOF_SUBTRAHEND_ANSATZ
...
def compute_statistics(sigma_deviations: List[float]) -> Dict[str, Any]:
    ...
    degrees_of_freedom = max(1, total_predictions - DOF_SUBTRAHEND_ANSATZ)
...
def generate_statistics() -> Dict[str, Any]:
    ...
    statistics = {
        ...
        "validation": {
            ...
            # Was FITTED_PARAMS_COUNT = 1, a fourth incompatible answer
            # alongside the 0 and the two 3s. Reads the ledger now.
            "calibrated_count": _free_variable_count(),
            "free_variable_count": _free_variable_count(),
            "constraints_count": 1,
            "exact_matches": validation_stats["exact_matches"],
        ...
        try:
            ...
            params_data['parameters']['framework_statistics.degrees_of_freedom'] = {
                ...
                'eml_description': (
                    ...
                    "— dof = N_pred - DOF_SUBTRAHEND_ANSATZ, with the subtrahend "
                    "asserted as 1 (b3, chi_eff and phi treated as mathematical). "
                    "This is not the free-variable count; see "
