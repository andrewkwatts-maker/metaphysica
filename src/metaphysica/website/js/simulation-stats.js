...
(function() {
    ...
    const SimulationStats = {
        ...
        async loadData() {
            // Try loading from multiple paths. Pages live under /Pages/, so
            // the ../ prefix is the one that resolves there; root-relative
            // /AutoGenerated/ covers the deployed site root.
            const paths = [
