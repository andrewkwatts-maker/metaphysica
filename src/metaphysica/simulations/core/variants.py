...
FORKS: Dict[str, Fork] = {
    "bulk_signature": Fork(
        ...
        notes="INDEPENDENT AND STILL OPEN whichever option is taken: the TCS "
              "obstruction. (b2,b3) = (4,24) cannot exist as a twisted "
              "connected sum (Crowley-Nordstrom parity forces b2 + b3 odd; "
              "4 + 24 = 28). b3 = 24 survives -- Joyce 1996 has (7,24) -- so "
              "it is b2 = 4, the 'four faces' reading, that fails. Also open: "
              "the Frobenius-Schur reality argument, which (24,2) fails on a "
              "test generated by the framework's own 13D(12,1) shadow claim.",
    ),
    "render_policy": Fork(
        id="render_policy",
