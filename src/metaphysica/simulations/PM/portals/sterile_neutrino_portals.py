...
PHYSICS (Part 3, Topic 08):
    ...
    For M_s ~ 10^4 GeV:
        m_nu ~ 0.57^2 * 246^2 / 10^4 GeV ~ 2 GeV  (12 orders above the
        2e-3 eV atmospheric scale — that target needs M_s ~ 10^16 GeV)
...
class SterileNeutrinoPortalsV23(SimulationBase):
    ...
    def __init__(self):
        ...
        self._metadata = SimulationMetadata(
            ...
            description=(
                ...
                "the type-I seesaw with these inputs yields ~2 GeV — reaching the "
                "2e-3 eV atmospheric scale requires M_s ~ 10^16 GeV, not 10^4. "
    ...
    def compute_sterile_portals(self) -> SterileNeutrinoResult:
        ...
        #             ~ 0.325 * 60516 / 10000
        #             ~ 1.97 GeV  (NOT the atmospheric scale — 12 orders high;
        #               2e-3 eV requires M_s ~ 10^16 GeV)
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "formula": (
                                ...
                                r"\approx 2\,\text{GeV} \;(\text{not } 2\times10^{-3}\,\text{eV; that value requires } M_s \sim 10^{16}\,\text{GeV})"
                            )
                        },
                    ],
                    "references": [
