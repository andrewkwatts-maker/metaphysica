...
GATE_PARAMS: Dict[int, Tuple[List[str], List[str]]] = {
    ...
    2:  (["topology.elder_kads"],
         []),
    3:  (["topology.ancestral_roots", "registry.node_count"],
         []),
    ...
    # ================================================================
    11: (["gauge.qcd_alpha_s_mz", "registry.node_count", "topology.ancestral_roots"],
         []),
    12: (["gauge.sin2_theta_w", "topology.elder_kads"],
         []),
    13: (["gauge.qcd_alpha_s_mz", "topology.ancestral_roots"],
         []),
    14: (["gauge.sin2_theta_w", "topology.ancestral_roots"],
         []),
    15: (["gauge.qcd_alpha_s_mz", "topology.ancestral_roots"],
         []),
    ...
    23: (["topology.ancestral_roots", "registry.node_count"],
         []),
    24: (["topology.ancestral_roots"],
         []),
    25: (["topology.ancestral_roots", "gauge.qcd_alpha_s_mz"],
         []),
    ...
    27: (["topology.elder_kads", "registry.node_count"],
         []),
    28: (["registry.node_count"],
         []),
    29: (["topology.elder_kads"],
         []),
    30: (["topology.ancestral_roots", "registry.node_count"],
         []),
    31: (["topology.elder_kads", "constants.k_gimel"],
         []),
    32: (["topology.elder_kads"],
         []),
    33: (["topology.elder_kads"],
         []),
    ...
    39: (["topology.elder_kads", "constants.k_gimel"],
         []),
    40: (["topology.ancestral_roots", "registry.node_count"],
         []),
    ...
    # ================================================================
    41: (["gravity.newton_constant_theory", "topology.ancestral_roots"],
         []),
    42: (["gravity.newton_constant_theory", "topology.ancestral_roots"],
         []),
    43: (["gravity.newton_constant_theory"],
         []),
    44: (["gravity.newton_constant_theory", "topology.elder_kads"],
         []),
    45: (["gravity.newton_constant_theory", "topology.ancestral_roots"],
         []),
    46: (["topology.ancestral_roots"],
         []),
    47: (["topology.ancestral_roots"],
         []),
    48: (["topology.ancestral_roots"],
         []),
    49: (["topology.ancestral_roots"],
         []),
    50: (["topology.ancestral_roots"],
         []),
    51: (["topology.ancestral_roots"],
         []),
    52: (["topology.ancestral_roots"],
         []),
    53: (["topology.ancestral_roots"],
         []),
    54: (["topology.ancestral_roots"],
         []),
    55: (["topology.ancestral_roots", "geometry.D_bulk"],
         []),
    ...
    # ================================================================
    56: (["topology.ancestral_roots", "geometry.D_bulk"],
         []),
    57: (["topology.ancestral_roots", "geometry.D_bulk"],
         []),
    58: (["topology.ancestral_roots", "geometry.D_bulk", "registry.node_count"],
         []),
    59: (["topology.ancestral_roots", "geometry.D_bulk"],
         []),
    60: (["topology.ancestral_roots", "geometry.D_bulk"],
         []),
