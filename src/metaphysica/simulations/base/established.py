    ...
    def _load_desi_values(cls, registry: 'PMRegistry') -> None:
        ...
        params = [
            ...
            EstablishedParameter(
                ...
                uncertainty=0.032,
                units="dimensionless",
                source="ESTABLISHED:HSC_Y3_2023",
                description=(
                    "S8 from HSC Year 3 weak gravitational lensing (Li et al. "
                    "2023, PRD 108, 123518). Uncertainty is the symmetric "
                    "average of the published +0.031/-0.034."
                ),
                eml_description="EML: eml_scalar(0.769) — S₈ from HSC Year 3 cosmic shear (input anchor)"
            ),
        ]
